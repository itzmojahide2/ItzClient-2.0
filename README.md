...
The Entrypoint specification can be found [here](src/client/kotlin/net/itzmojahide/itzclient/api/BewisclientAPIEntrypoint.kt).

## Rebranded as ItzClient
Based on BewisClient-v3 by Bewis09 (CC-BY 4.0). Modified and rebranded by itzmojahide. Target Minecraft: 1.21.1, Fabric Loader >=0.16.0.
